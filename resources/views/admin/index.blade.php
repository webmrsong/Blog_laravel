@extends('layouts.admin')
        @section('content')
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="sub_menu">
                            ...
                            <li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-gears"></i>配置项</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="sub_menu">
                            ...
                            <li><a href="http://www.mrsong.me" target="main"><i class="fa fa-fw fa-tags"></i>其他组件</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div class="bottom_box">
                CopyRight © 2017. Powered By <a href="http://www.mrsong.me">http://www.mrsong.me</a>.
            </div>
            <!--底部 结束-->
        @endsection
